...
function mostrarDetalles(data, abr) {
    const playerStatsBody = document.getElementById('detailed');

    //hay que filtrar por abreviaciones de ambos equipos supongo, o por id del partido!!
        ...
        for (var i = 0; i < n_equipos; i+=2) {
            ...
            if (pts_visitante>pts_local){
                ...
                row.innerHTML = `
                    ...
                    <td class = 'win'>${pts_visitante}</td>
                    <td>${team_visitante}</td>
                    <td><button id=${visitante_abreviation} onclick="detalles(${visitante_abreviation})">Stats</button</td>
                ...
                row.innerHTML = `
                    ...
                    <td>${pts_visitante}</td>
                    <td>${team_visitante}</td>
                    <td><button id=${local_abreviation} onclick ="detalles(${local_abreviation})">Stats</button</td>
